            ...
            FromCharToBool = (value) =>
            {
                switch (value)
                {
                    ...
                    case 'f':
                        return false;
                    default:
                        throw new InvalidCastException($"TSqlBooleanTranslator could not translate '{typeof(String).FullName}' to '{typeof(Boolean).FullName}'");
