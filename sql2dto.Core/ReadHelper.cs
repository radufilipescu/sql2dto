...
namespace sql2dto.Core
{
    public class ReadHelper : IDisposable
    {
        ...
        public object GetValue<TDto>(string propName, string columnsPrefix = null)
        {
        ...
        public object GetNullableValue<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public object GetValue<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
        ...
        public object GetNullableValue<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public bool GetBoolean<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public bool? GetNullableBoolean<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public bool GetBoolean<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public bool? GetNullableBoolean<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public byte GetByte<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public byte GetByte<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public long GetBytes<TDto>(string propName, long fieldOffset, byte[] buffer, int bufferoffset, int length)
        {
        ...
        public long GetBytes<TDto>(string propName, string columnsPrefix, long fieldOffset, byte[] buffer, int bufferoffset, int length)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public long GetBytes<TDto>(DtoMapper<TDto> mapper, string propName, long fieldOffset, byte[] buffer, int bufferoffset, int length)
        {
        ...
        public long GetBytes<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix, long fieldOffset, byte[] buffer, int bufferoffset, int length)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public char GetChar<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public char GetChar<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public long GetChars<TDto>(string propName, long fieldOffset, char[] buffer, int bufferoffset, int length)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, null);
            if (ordinal.HasValue)
            {
        ...
        public long GetChars<TDto>(string propName, string columnsPrefix, long fieldOffset, char[] buffer, int bufferoffset, int length)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public long GetChars<TDto>(DtoMapper<TDto> mapper, string propName, long fieldOffset, char[] buffer, int bufferoffset, int length)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, null);
            if (ordinal.HasValue)
            {
        ...
        public long GetChars<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix, long fieldOffset, char[] buffer, int bufferoffset, int length)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public string GetDataTypeName<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public string GetDataTypeName<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public DateTime GetDateTime<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public DateTime? GetNullableDateTime<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public DateTime GetDateTime<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public DateTime? GetNullableDateTime<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public decimal GetDecimal<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public decimal? GetNullableDecimal<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public decimal GetDecimal<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public decimal? GetNullableDecimal<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public double GetDouble<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public double? GetNullableDouble<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public double GetDouble<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public double? GetNullableDouble<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public Type GetFieldType<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public Type GetFieldType<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public float GetFloat<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public float? GetNullableFloat<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public float GetFloat<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public float? GetNullableFloat<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public Guid GetGuid<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public Guid? GetNullableGuid<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public Guid GetGuid<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public Guid? GetNullableGuid<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public short GetInt16<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public short? GetNullableInt16<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public short GetInt16<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public short? GetNullableInt16<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public int GetInt32<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public int? GetNullableInt32<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public int GetInt32<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public int? GetNullableInt32<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public long GetInt64<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public long? GetNullableInt64<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public long GetInt64<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public long? GetNullableInt64<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public string GetString<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public string GetNullableString<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public string GetString<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public string GetNullableString<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public bool IsDBNull<TDto>(string propName, string columnsPrefix = null)
        {
            int? ordinal = DtoMapper<TDto>.Default.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public bool IsDBNull<TDto>(DtoMapper<TDto> mapper, string propName, string columnsPrefix = null)
        {
            int? ordinal = mapper.ExtractOrdinal(this, propName, columnsPrefix);
            if (ordinal.HasValue)
            {
        ...
        public FetchOperation<TDto> Fetch<TDto>(Dictionary<string, object> injectedValues = null)
           
        {
            return FetchOperation<TDto>.Create(this, injectedValues);
        }

        public FetchOperation<TDto> Fetch<TDto>(DtoMapper<TDto> mapper, Dictionary<string, object> injectedValues = null)
           
        {
            return FetchOperation<TDto>.Create(this, mapper, injectedValues);
        }

        public FetchOperation<TDto> Fetch<TDto>(string columnsPrefix, Dictionary<string, object> injectedValues = null)
           
        {
            return FetchOperation<TDto>.Create(columnsPrefix, this, injectedValues);
        }

        public FetchOperation<TDto> Fetch<TDto>(string columnsPrefix, DtoMapper<TDto> mapper, Dictionary<string, object> injectedValues = null)
           
        {
            return FetchOperation<TDto>.Create(columnsPrefix, this, mapper, injectedValues);
        }
        #endregion
